      ...
      {/* <Footer.Divider /> */}
        ...
        <div className="w-full sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mt-4 flex space-x-6 sm:mt-0 sm:justify-center ">
            <Footer.Icon href="https://github.com/mingxiangzhangmark" icon={BsGithub} className="hover:text-gray-700 transition ease-in-out " title="Github"/>
            <Footer.Icon href="https://linkedin.com/in/mark-zhang-04b3722b7" icon={BsLinkedin} className="hover:text-gray-700 transition ease-in-out" title="Linkedin"/>
            <Footer.Icon href="#" icon={BsFacebook} className="hover:text-gray-700 transition ease-in-out" title="Facebook"/>
            <Footer.Icon href="#" icon={SiUdemy} className="hover:text-gray-700 transition ease-in-out" title="Udemy"/>
            <Footer.Icon href="#" icon={BsTwitter} className="hover:text-gray-700 transition ease-in-out" title="Twitter"/>
